...
"-----------------------------------------------------------------------------------
"
inoremap <silent> <F2>c class<CR>end<ESC>kA<space>
inoremap <silent> <F2>w while<CR>end<ESC>kA<space>
inoremap <silent> <F2>f def<CR>end<ESC>kA<space>
inoremap <silent> <F2>d do<CR>end<ESC>kA<space>
inoremap <silent> <F2>i if<CR>end<ESC>kA<space>
inoremap <silent> <F2>r require<space>''<left>
inoremap <silent> <F2>m module<CR>end<ESC>kA<space>
inoremap <silent> <F2>b begin<CR>end<ESC>kA<space>

inoremap <silent> <F2>p puts<space>

inoremap <silent><% <%<space><space>%><esc>hhi
inoremap <silent><= <%=<space><space>%><esc>hhi
